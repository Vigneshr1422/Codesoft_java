...
public class Task_03_Atm_Interfce {
    private BankAccount[] accounts;
    private BankAccount currentAccount;
    private int loginAttempts;

    public Task_03_Atm_Interfce(BankAccount[] accounts) {
    ...
    public static void main(String[] args) {
        ...
        BankAccount[] accounts = {
                new BankAccount("12345", "1422", 500),
                new BankAccount("12365", "6781", 100),
                new BankAccount("14782", "85214", 1500)
        };
        Task_03_Atm_Interfce atm = new Task_03_Atm_Interfce(accounts);
